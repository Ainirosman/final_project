...
class _BuyerProductDetailsState extends State<BuyerProductDetails> {
        ...
        Card(
          ...
          child: SizedBox(
              ...
              child: CachedNetworkImage(
                ...
                fit: BoxFit.cover,
                imageUrl:
                    "http://10.19.28.25/homestay/assets/productimages/${widget.product.productId}.png",
  ...
  Future<void> _onRoute() async {
    final Uri launchUri = Uri(
        scheme: 'https',
        path: "www.google.com/maps/@${widget.product.productLat},${widget.product.productLng}20z");
    await launchUrl(launchUri);
  }
