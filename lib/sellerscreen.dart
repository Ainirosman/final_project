...
class _SellerScreenState extends State<SellerScreen> {
                              ...
                              child: Column(children: [
                                ...
                                Flexible(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fit: BoxFit.cover,
                                    imageUrl:
                                        "http://10.19.28.25/homestay/server/productimages/${productList[index].productId}.png",
  ...
  void _loadProducts() {
    ...
    http
        .get(
      Uri.parse(
          "http://10.31.29.183/homestay/php/loadsellerproduct.php?userid=${widget.user.id}"),
    )
        .then((response) {
  ...
  void _deleteProduct(index) {
    try {
      http.post(Uri.parse("http://localhost/homestay/php/delete_product.php"), body: {
