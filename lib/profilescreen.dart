...
import 'package:hello_world/registration.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  File? _image;
  var pathAsset = "assets/images/profiles.png";
                            ...
                            child: GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: "http://10.19.28.25/homestay/server/profileimages",
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (content) => const RegistrationForm()));
              },
            ),
            TextButton(
              child: const Text(
  ...
  void _updateProfileImage(image) {
    ...
    http.post(Uri.parse("http://10.31.29.183/homestay/php/update_profile.php"),
        body: {
  ...
  void _updateName(String newname) {
    http.post(Uri.parse("http://localhost/homestay/php/update_profile.php"),
        body: {
          "userid": widget.user.id,
          "newname": newname,
        }).then((response) {
  ...
  void _updatePhone(String newphone) {
    http.post(Uri.parse("http://10.19.28.25/php/update_profile.php"),
        body: {
          "userid": widget.user.id,
          "newphone": newphone,
        }).then((response) {
