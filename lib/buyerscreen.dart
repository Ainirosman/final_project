...
import 'buyerproductdetail.dart';
...
//for pagination
                              ...
                              child: Column(children: [
                                ...
                                Flexible(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    fit: BoxFit.cover,
                                    imageUrl:
                                        "http://10.31.29.183/homestay/server/productimages/${productList[index].productId}.png",
  ...
  void _loadProducts(String search, int pageno) {
    ...
    http
        .get(
      Uri.parse(
          "http://10.19.28.25/homestay/php/loadallproduct.php?search=$search&pageno=$pageno"),
    )
        .then((response) {
  ...
  loadSingleSeller(int index) {
    http.post(Uri.parse("http://10.19.28.25/homestay/php/load_seller.php"),
